...
//
//      override def getPropertyInfo(url: String, info: Properties): Array[DriverPropertyInfo] = Array("jdbc:mysql://localhost:3306/cdp",properties)
//
...
//
//      override def getParentLogger: Logger = new Logger()
//    }
//
